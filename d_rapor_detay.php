...
$sql="select *from m_olan_tablo where d_tc='$secilen_doktor' and m_tarih='$s_tarih' ";
       ...
       $sql="select *from m_olan_tablo where d_tc='$secilen_doktor'";
         $sonuc=mysql_query($sql);
...
<tr>
<td><b>TC:</b></td>
<td><input name='tc' type='text' value='$satir[d_tc]'  maxlength='60' disabled='readonly' style='width:275px; border:1px solid #999999;' class='ui-corner-all' /></td>
<td><b> </b></td>
 <td> </td>
</tr>
<tr>
<td><b>UNVAN:</b></td>
<td><input name='ad' type='text' value='$satir[d_unvan]'  maxlength='60' disabled='readonly' style='width:275px; border:1px solid #999999;' class='ui-corner-all' /></td>
<td><b></b></td>
<td></td>
</tr>
<tr>
<td><b>AD SOYAD:</b></td>
<td><input name='soyad' type='text' value='$satir[d_ad] $satir[d_soyad]'  maxlength='60' disabled='readonly' style='width:275px; border:1px solid #999999;' class='ui-corner-all' /></td>
<td> </td>
<td> </td>
</tr>
<tr>
